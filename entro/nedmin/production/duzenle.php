...
$bilgilerimsor=$db->prepare("SELECT * from kullanicilar where id=:id");
...
<form action="islem1.php" method="POST">
    ...
    <input type="text" required="" name="kullanici_adi" value="<?php echo $bilgilerimcek['kullanici_adi'] ?>">
    <input type="email" required="" name="email" value="<?php echo $bilgilerimcek['email'] ?>">
    <input type="text" required="" name="parola" value="<?php echo $bilgilerimcek['parola'] ?>">
